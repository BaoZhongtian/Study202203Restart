...
def build_ncls_neo(sample_number=None, tokenizer=None, train_part_shuffle=False):
    train_data_raw = ncls_loader_EN2ZH(sample_number, use_part='train')
    test_data_raw = ncls_loader_EN2ZH(use_part='test')
...
def build_masked_article_label(sample, keywords_number=10):
    keywords_dictionary = {}
    ...
    return current_article, current_lm_sentence
...
def build_mask_ncls_for_mt5(sample_number=None):
    train_data = ncls_loader_EN2ZH(sample_number, use_part='train')
    test_data = ncls_loader_EN2ZH(use_part='test')
