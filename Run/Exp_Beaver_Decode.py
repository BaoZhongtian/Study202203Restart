...
if __name__ == '__main__':
    valid_dataset = build_dataset(use_part='test', batch_shape_limit=256)
    ...
    checkpoint = torch.load("E:/ProjectData/NCLS/Beaver-AllData-220307-160815/checkpoint-step-1635000")
    model.load_state_dict(checkpoint["model"])

    model.eval()
    counter = 0
    save_path = 'E:/ProjectData/NCLS/Predict-Another/'
